...
public class NotificacionImplement implements NotificacionService {
  ...
  public void notificacionCitaCancelada(Cita cita, Usuario compradorOVendedor) throws IOException {
    ...
    NotificacionPeticion notifComprador = buildNotificacion(
            ...
            "https://terranovaspring-production.up.railway.app/comprador/citas",
            "citaCancelada",
    ...
    NotificacionPeticion notifVendedor = buildNotificacion(
            ...
            "https://terranovaspring-production.up.railway.app/vendedor/citas",
            "citaCancelada",
            cita.getProducto().getNombreProducto(),
            comprador.getNombres(),
            vendedor.getNombres()
  ...
  public void notificacionRecuperarContrasena(String email) throws IOException {
    NotificacionPeticion notificacionPeticion = buildNotificacion(
            ...
            "Recuperacion de contrasena",
            "https://terranovaspring-production.up.railway.app/login/recuperar-password",
            "recuperarContrasena",
            null,
            "ninguno",
            null
  ...
  public void notificacionVentaGenerada(Venta venta) throws IOException {
    ...
    NotificacionPeticion notifiComprador = buildNotificacion(
            ...
            "https://terranovaspring-production.up.railway.app/comprador/compras",
            "ventaGenerada",
    ...
    NotificacionPeticion notifVendedor = buildNotificacion(
            ...
            "https://terranovaspring-production.up.railway.app/vendedor/ventas",
  ...
  public void notificacionContraoferta(Venta venta) throws IOException {
    ...
    NotificacionPeticion notifiComprador = buildNotificacion(
            ...
            "Modificacion en datos de compra para el producto: " + producto,
            "https://terranovaspring-production.up.railway.app/comprador/compras/detalle/" + venta.getIdVenta(),
            "ventaFinalizacion",
            venta.getProducto().getNombreProducto(),
            vendedor.getNombres(),
            comprador.getNombres()
  ...
  public void notificacionFotoPerfilCambiada(Usuario usuario) throws IOException {
    NotificacionPeticion notificacionPeticion = buildNotificacion(
            ...
            "Cambiaste tu foto.",
            "https://terranovaspring-production.up.railway.app/usuarios/mi-perfil?id=1",
            "fotoCambiada",
            "ninguno",
            "ninguno",
            usuario.getNombres()
